...
if (isset($_POST['submit'])) {
    ...
    if ($new_password !== $confirm_password) {
        ...
        try {
            ...
            $mail->Body    = "Hello $shopName,\n\nUse this verification code to confirm your new password: $verification_code\n\nIf you did not request this, ignore this email.";
        ...
        <main class="flex-1 flex flex-col items-center justify-center p-6 md:p-12">
            <div class="w-full max-w-2xl bg-white dark:bg-navy-dark rounded-xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                <div class="relative h-32 w-full bg-primary/10 flex items-center px-8 border-b border-slate-100 dark:border-slate-800 overflow-hidden">
                    ...
                    <p class="text-slate-500 dark:text-slate-400 mt-1">Keep your account secure with a strong password.</p>
                    ...
                    <form method="POST" class="space-y-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <input type="password" name="new_password" placeholder="Min. 8 characters" class="w-full pl-12 pr-12 h-12 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all"/>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <input type="password" name="confirm_password" placeholder="Re-type your new password" class="w-full pl-12 pr-12 h-12 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all"/>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-4 pt-4">
                            ...
                            <a href="dashboardadmin.php" class="w-full sm:w-32 h-12 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold rounded-lg flex items-center justify-center">Cancel</a>
                        </div>
                    </form>
                </div>
                ...
                <div class="px-8 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1">
                        ...
                        <li class="flex items-center gap-2 text-xs text-slate-500">
                            <span class="material-symbols-outlined text-[14px] text-slate-300">circle</span> One special character
                        </li>
                        <li class="flex items-center gap-2 text-xs text-slate-500">
                            <span class="material-symbols-outlined text-[14px] text-slate-300">circle</span> One uppercase letter
                        </li>
                        <li class="flex items-center gap-2 text-xs text-slate-500">

...
<div class="flex h-screen overflow-hidden pt-16 md:pt-0">
    ...
    <aside id="sidebar" class="fixed md:static left-0 top-0 h-screen w-64 flex-shrink-0 border-r border-slate-200 bg-white flex flex-col overflow-y-auto z-40 -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out pt-16 md:pt-0">
        <div class="p-6">
            ...
            <nav class="space-y-1">
                <?php if (canAccessStorageModule('dashboardadmin.php', $accessibleModules)): ?>
                    <a href="dashboardadmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                ...
                <?php if (canAccessStorageModule('repairjobsadmin.php', $accessibleModules)): ?>
                    <a href="repairjobsadmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                ...
                <?php if (canAccessStorageModule('vehicleadmin.php', $accessibleModules)): ?>
                    <a href="vehicleadmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                ...
                <?php if (canAccessStorageModule('appointmentadmin.php', $accessibleModules)): ?>
                    <a href="appointmentadmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                ...
                <?php if (canAccessStorageModule('inventoryadmin.php', $accessibleModules)): ?>
                    <a href="inventoryadmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                ...
                <?php if (canAccessStorageModule('customeradmin.php', $accessibleModules)): ?>
                    <a href="customeradmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                ...
                <?php if (canAccessStorageModule('paymentsadmin.php', $accessibleModules)): ?>
                    <a href="paymentsadmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                ...
                <?php if (canAccessStorageModule('reportsadmin.php', $accessibleModules)): ?>
                    <a href="reportsadmin.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors">
                        <span class="material-symbols-outlined text-[22px]">description</span> Reports
                    </a>
                <?php endif; ?>

                <div class="pt-4 mt-4 border-t border-slate-100">
                    <button type="button" id="settingsDropdownBtn" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-blue-50 text-primary font-bold w-full transition-colors">
                    ...
                    <div id="settingsDropdownMenu" class="mt-1 ml-8 space-y-1">
                        <?php if (canAccessStorageModule('storage_managementadmin.php', $accessibleModules)): ?>
                            <a href="storage_managementadmin.php" class="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 text-primary font-bold text-sm">
                        ...
                        <?php if (canAccessStorageModule('accountbillingadmin.php', $accessibleModules)): ?>
                            <a href="accountbillingadmin.php" class="flex items-center gap-2 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors text-sm">
                        ...
                        <?php if (canAccessStorageModule('websitecustomeadmin.php', $accessibleModules)): ?>
                            <a href="websitecustomeadmin.php" class="flex items-center gap-2 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors text-sm">
                        ...
                        <?php if (canAccessStorageModule('settingsadmin.php', $accessibleModules)): ?>
                            <a href="settingsadmin.php" class="flex items-center gap-2 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors text-sm">
    ...
    <main class="flex-1 overflow-y-auto flex flex-col">
        <header class="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md flex items-center justify-between px-8 h-16">
            <div>
                <h2 class="text-lg font-black text-slate-900 tracking-tight">Storage Management</h2>
            </div>

            <div class="flex items-center gap-4">
                <button class="p-2 text-slate-500 hover:text-primary transition-all"><span class="material-symbols-outlined">notifications</span></button>
                <button class="p-2 text-slate-500 hover:text-primary transition-all"><span class="material-symbols-outlined">help_outline</span></button>
            </div>
        </header>
        ...
        <div class="p-8 space-y-8 flex-1">
            <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-1">View storage usage and database records used by this repair shop.</p>
                </div>

                <div class="flex gap-3">
                    <a href="accountbillingadmin.php" class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg text-sm font-bold hover:bg-blue-800 transition-colors">
                        <span class="material-symbols-outlined text-[18px]">upgrade</span> Upgrade Plan
                    </a>

                    <button onclick="loadStorage()" class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-bold text-slate-700 hover:bg-slate-50 transition-colors">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
                    <div class="flex justify-between items-start mb-6">
                        <div class="flex items-center gap-2">
                            <div class="p-2 bg-blue-50 rounded-lg"><span class="material-symbols-outlined text-primary">cloud</span></div>
                            <div>
                        ...
                        <span id="percentageText" class="text-xl font-black text-primary bg-blue-50 px-3 py-1 rounded-full">0%</span>
                    </div>

                    <div class="mb-5">
                        <p class="text-4xl font-black text-slate-900">
                            <span id="usedStorage">0 GB</span>
                            <span class="text-base font-medium text-slate-500">of <span id="limitStorage">0 GB</span> used</span>
                        </p>
                    </div>

                    <div class="w-full h-5 bg-slate-100 rounded-full overflow-hidden">
                        <div id="storageBar" class="h-full bg-primary rounded-full transition-all duration-500" style="width: 0%;"></div>
                    </div>

                    <p id="storageMessage" class="mt-4 text-sm font-semibold text-slate-500">Checking storage status...</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        ...
                        <div class="bg-slate-50 rounded-lg p-4 border border-slate-200">
                            <p class="text-xs text-slate-500 font-bold uppercase tracking-wide">Next Billing Date</p>
                ...
                <div class="bg-slate-900 text-white rounded-lg p-6 shadow-sm relative overflow-hidden">
                    <div class="relative z-10 flex flex-col h-full justify-between">
                        <div>
                            <div class="p-2 bg-white/10 rounded-lg inline-flex mb-4"><span class="material-symbols-outlined text-white">workspace_premium</span></div>
                            <h3 class="text-2xl font-black mb-3">Need more storage?</h3>
                            <p class="text-slate-300 text-sm leading-relaxed">Upgrade your subscription plan to increase file storage for documents, vehicle images, repair photos, receipts, and reports.</p>
                        </div>
                        <a href="accountbillingadmin.php" class="mt-6 block text-center bg-white text-slate-900 font-black px-5 py-3 rounded-lg hover:bg-blue-50 transition-colors">View Billing</a>
                    </div>
                    <div class="absolute -right-10 -bottom-10 opacity-10"><span class="material-symbols-outlined text-[160px]">cloud_upload</span></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-500">These files are counted from your tenant upload folder.</p>
                    </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-5 gap-4">
                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-blue-50 rounded-lg inline-flex mb-3"><span class="material-symbols-outlined text-primary">folder</span></div>
                        <p class="text-sm text-slate-500">Used Storage</p>
                        <p id="usedMB" class="text-2xl font-black text-slate-800">0 MB</p>
                    </div>

                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-blue-50 rounded-lg inline-flex mb-3"><span class="material-symbols-outlined text-primary">database</span></div>
                        <p class="text-sm text-slate-500">Storage Limit</p>
                        <p id="limitGB" class="text-2xl font-black text-slate-800">0 GB</p>
                    </div>

                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-emerald-50 rounded-lg inline-flex mb-3"><span class="material-symbols-outlined text-emerald-600">verified</span></div>
                        <p class="text-sm text-slate-500">Status</p>
                        <p id="storageStatus" class="text-2xl font-black text-emerald-600">Normal</p>
                    </div>

                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-purple-50 rounded-lg inline-flex mb-3"><span class="material-symbols-outlined text-purple-600">table_rows</span></div>
                        <p class="text-sm text-slate-500">Database Records</p>
                        <p id="totalRecords" class="text-2xl font-black text-slate-800">0</p>
                    </div>

                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-slate-100 rounded-lg inline-flex mb-3"><span class="material-symbols-outlined text-slate-600">folder_open</span></div>
                        <p class="text-sm text-slate-500">Tenant Folder</p>
                        <p class="text-sm font-bold text-slate-800 break-all mt-1">uploads/tenants/<?= $tenantID ?>/</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-200 bg-slate-50">
                    ...
                    <p class="text-sm text-slate-500">Total saved database records used by this tenant. Services are not included.</p>
                </div>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
                <div class="flex items-start gap-4">
                    <div class="p-2 bg-blue-100 rounded-lg"><span class="material-symbols-outlined text-primary">tips_and_updates</span></div>
                    <div>
                        <h3 class="text-lg font-black text-slate-900">Storage Reminder</h3>
                        <p class="text-sm text-slate-600 mt-1">When storage reaches 80%, the system will show a warning. When it reaches 100%, upgrade the plan or remove unused uploaded files.</p>
                    </div>
                </div>
            </div>
        </div>

        <footer class="bg-white border-t border-slate-200 px-8 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex gap-8">
                <div class="flex items-center gap-3">
                    <div class="p-1.5 bg-blue-50 rounded"><span class="material-symbols-outlined text-primary text-base">cloud</span></div>
                    <div>
                        <p class="text-[10px] text-slate-400 font-black uppercase tracking-widest">Storage Monitoring</p>
                        <p class="text-sm font-bold text-slate-900">Active</p>
                    </div>
                </div>

                <div class="hidden md:flex items-center gap-3">
                    <div class="p-1.5 bg-blue-50 rounded"><span class="material-symbols-outlined text-primary text-base">business</span></div>
                    <div>
...
function loadStorage() {
    fetch("storage_api.php?refresh=" + Date.now())
        ...
        .then(data => {
            ...
            setText("usedStorage", (data.used_gb ?? 0) + " GB");
            ...
            setText("usedMB", (data.used_mb ?? 0) + " MB");

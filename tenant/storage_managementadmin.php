...
<div class="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-slate-200 px-4 py-3 z-50 flex items-center justify-between">
    ...
    <h2 class="text-lg font-bold truncate flex-1 ml-3">
        <?= h($shopName) ?>
    </h2>
</div>
            ...
            <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-1">
                        View how much storage your shop has used for uploaded images, documents, receipts, and repair files.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p id="planName" class="text-sm text-slate-500">
                        ...
                        <span id="percentageText"
                              class="text-xl font-black text-primary bg-blue-50 px-3 py-1 rounded-full">
                            0%
                        </span>
                    </div>
                    ...
                    <div class="mb-5">
                        <p class="text-4xl font-black text-slate-900">
                            ...
                            <span class="text-base font-medium text-slate-500">
                                of <span id="limitStorage">0 GB</span> used
                            </span>
                        </p>
                    </div>
                    ...
                    <p id="storageMessage" class="mt-4 text-sm font-semibold text-slate-500">
                ...
                <div class="bg-slate-900 text-white rounded-lg p-6 shadow-sm relative overflow-hidden">
                    <div class="relative z-10 flex flex-col h-full justify-between">
                        <div>
                            <div class="p-2 bg-white/10 rounded-lg inline-flex mb-4">
                            ...
                            <p class="text-slate-300 text-sm leading-relaxed">
                                Upgrade your subscription plan to increase file storage for business documents,
                                vehicle images, repair photos, receipts, and reports.
                            </p>
                        </div>

                        <a href="accountbillingadmin.php"
                           class="mt-6 block text-center bg-white text-slate-900 font-black px-5 py-3 rounded-lg hover:bg-blue-50 transition-colors">
                            View Billing
                        </a>
                    </div>

                    <div class="absolute -right-10 -bottom-10 opacity-10">
                        <span class="material-symbols-outlined text-[160px]">cloud_upload</span>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            These files are counted from your tenant upload folder.
                        </p>
                    </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-blue-50 rounded-lg inline-flex mb-3">
                    ...
                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-emerald-50 rounded-lg inline-flex mb-3">
                    ...
                    <div class="border border-slate-200 rounded-lg p-4 bg-white">
                        <div class="p-2 bg-slate-100 rounded-lg inline-flex mb-3">
                            <span class="material-symbols-outlined text-slate-600">folder_open</span>
                        </div>
                        <p class="text-sm text-slate-500">Tenant Folder</p>
                        <p class="text-sm font-bold text-slate-800 break-all mt-1">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-600 mt-1">
                            When storage reaches 80%, the system will show a warning. When it reaches 100%,
                            you should upgrade the plan or remove unused uploaded files.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-8">
                ...
                <div class="flex items-center gap-3">
                    <div class="p-1.5 bg-blue-50 rounded">
                        <span class="material-symbols-outlined text-primary text-base">cloud</span>
                    </div>
...
function loadStorage() {
    fetch("storage_api.php")
        ...
        .then(data => {
            if (!data.success) {
                document.getElementById("planName").innerText = data.message;
                document.getElementById("storageMessage").innerText = data.message;
                document.getElementById("storageMessage").className = "mt-4 text-sm font-semibold text-red-600";
                return;
            }

            const percentage = data.percentage;

            document.getElementById("planName").innerText = data.plan_name + " Plan";
            document.getElementById("percentageText").innerText = percentage + "%";
            document.getElementById("usedStorage").innerText = data.used_gb + " GB";
            document.getElementById("limitStorage").innerText = data.storage_limit_gb + " GB";

            document.getElementById("planBox").innerText = data.plan_name;
            document.getElementById("billingCycle").innerText = formatText(data.billing_cycle);
            document.getElementById("nextBilling").innerText = data.next_billing_date ?? "—";

            document.getElementById("usedMB").innerText = data.used_mb + " MB";
            document.getElementById("limitGB").innerText = data.storage_limit_gb + " GB";
            ...
            if (data.is_full) {
                bar.className = "h-full bg-red-600 rounded-full transition-all duration-500";
                ...
                percentText.className = "text-xl font-black text-red-600 bg-red-50 px-3 py-1 rounded-full";
            } else if (data.is_warning) {
                bar.className = "h-full bg-orange-500 rounded-full transition-all duration-500";
                ...
                percentText.className = "text-xl font-black text-orange-600 bg-orange-50 px-3 py-1 rounded-full";
            } else {
                bar.className = "h-full bg-primary rounded-full transition-all duration-500";
                ...
                percentText.className = "text-xl font-black text-primary bg-blue-50 px-3 py-1 rounded-full";
            }
        })
        .catch(error => {
            console.error(error);
            document.getElementById("storageMessage").innerText = "Failed to load storage data.";
            document.getElementById("storageMessage").className = "mt-4 text-sm font-semibold text-red-600";
        });
}

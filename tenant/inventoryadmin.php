            ...
            <div class="p-6 flex-1">
                ...
                <nav class="space-y-1">
                    ...
                    <div class="pt-4 mt-4 border-t border-slate-100 dark:border-slate-800">
                        ...
                        <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                            href="accountbillingadmin.php?shop=<?php echo $shopQuery; ?>"><span
                                class="material-symbols-outlined text-[22px]">receipt_long</span>Account Billing</a>
                        <?php endif; ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold truncate">
                            <?php echo htmlspecialchars($shopName, ENT_QUOTES, 'UTF-8'); ?></p>
        ...
        <div class="flex-1 flex flex-col min-w-0 bg-background-light dark:bg-background-dark overflow-y-auto">
            <header
                ...
                <div class="flex items-center gap-6">
                    <h2 class="text-lg font-black text-slate-900 dark:text-white tracking-tight">Inventory Management
                    </h2>
                    <div class="relative hidden lg:block">
                        <span
                            class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm">search</span>
                        <form method="get" action="inventoryadmin.php" class="inline">
                            <input type="hidden" name="shop"
                                value="<?php echo htmlspecialchars($loginSlug, ENT_QUOTES, 'UTF-8'); ?>" />
                            <input
                                class="bg-surface-variant border-none rounded-lg pl-10 pr-4 py-1.5 text-sm w-64 focus:ring-2 focus:ring-primary/20"
                                name="q" value="<?php echo htmlspecialchars($search, ENT_QUOTES, 'UTF-8'); ?>"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="text-right hidden sm:block">
                            <p class="text-xs font-bold text-on-background">
                                <?php echo htmlspecialchars($shopName, ENT_QUOTES, 'UTF-8'); ?></p>
                            <p class="text-[10px] text-slate-500 uppercase font-semibold">Inventory</p>
                        </div>

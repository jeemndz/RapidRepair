...
if ($stmt->execute()) {
    ...
    // ✅ get new service_id for logs
    $newServiceId = (int)$stmt->insert_id;
    $stmt->close();
    ...
    log_event(
        ...
        "services",
        $newServiceId,
        "Invoice created for appointment #{$appointment_id} | client #{$client_id} | vehicle #{$vehicle_id} | category: {$serviceCategory} | total: ₱" . number_format($totalCost, 2)
    );

    // ✅ LOG: appointment marked invoiced
    log_event(
        $conn,
        "Update Appointment Status",
        "appointment",
        $appointment_id,
        "Status set to 'Invoiced' after invoice creation"
    );
    ...
    <div class="layout">
        <aside class="sidebar">
            <ul>
                ...
                <li><a href="create_client.php">Client Records</a></li>
                <li class="active"><a href="services.php">Service & Invoice</a></li>
        ...
        <div class="content">
            ...
            <div class="table-tools">
                ...
                <select id="sortAppointments" class="sort-select">
                    ...
                    <option value="recent">Recently Added (by ID)</option>
                </select>
            </div>
            ...
            <div class="table-tools">
                ...
                <select id="sortInvoices" class="sort-select">
                    <option value="latest">Latest (Newest first)</option>
                    <option value="oldest">Oldest (Oldest first)</option>
                    <option value="recent">Recently Added (by Service ID)</option>
                </select>
            </div>

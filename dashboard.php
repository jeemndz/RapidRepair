...
<div class="layout">
    ...
    <main class="content">
        <div class="dash-header">
            ...
            <div class="filters">
                <a class="filter-btn <?= ($range==='today') ? 'active' : '' ?>" href="dashboard.php?range=today">Today</a>
                <a class="filter-btn <?= ($range==='week') ? 'active' : '' ?>" href="dashboard.php?range=week">Weekly</a>
                <a class="filter-btn <?= ($range==='month') ? 'active' : '' ?>" href="dashboard.php?range=month">Monthly</a>
            </div>
        </div>

...
<head>
    ...
    <title>RapidRepair - Admin Login</title>
...
<body class="font-display text-slate-900 antialiased bg-slate-50">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 md:p-16 bg-white">
            ...
            <div class="w-full max-w-[440px]">
                ...
                <div class="mb-8">
                    <h2 class="text-3xl font-bold mb-2 text-slate-900">Partner Login</h2>
                ...
                <form class="space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div
                            ...
                            <button
                                class="flex items-center px-3 bg-slate-100 text-slate-500 hover:text-primary transition-colors"
                                type="button">
                ...
                <div class="mt-12 flex justify-center gap-6">
                    ...
                    <a class="text-xs text-slate-500 hover:text-primary transition-colors" href="#">Help Center</a>
                </div>
    ...
    <!-- EDIT BUTTON CONNECTED TO LOGINCUSTOM.PHP -->
    <a href="logincustom.php">
        <button aria-label="Edit Login Customization"

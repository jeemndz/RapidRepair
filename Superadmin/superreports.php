...
<body class="bg-background text-on-background antialiased selection:bg-primary-container selection:text-primary">
    <aside class="flex flex-col fixed left-0 top-0 h-full z-50 w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 font-['Inter'] antialiased tracking-tight shadow-sm dark:shadow-none">
        ...
        <nav class="flex-1 px-4 space-y-1 mt-4">
            <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-lg active:scale-95" href="superadd.php">
                <span class="material-symbols-outlined" data-icon="dashboard">dashboard</span>
                <span class="text-sm">Dashboard</span>
            </a>
            <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-lg active:scale-95" href="superaddtenants.php">
                <span class="material-symbols-outlined" data-icon="groups">groups</span>
                <span class="text-sm">Tenants</span>
            </a>
            <a class="flex items-center gap-3 px-3 py-2.5 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 font-bold border-r-4 border-blue-700 dark:border-blue-500 rounded-lg active:scale-95" href="superreports.php">
                <span class="material-symbols-outlined" data-icon="bar_chart">bar_chart</span>
                <span class="text-sm">Reports</span>
            </a>
            <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-lg active:scale-95" href="subscriptionmanage.php">
                <span class="material-symbols-outlined" data-icon="subscriptions">subscriptions</span>
                <span class="text-sm">Subscriptions</span>
            </a>
            <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-lg active:scale-95" href="supersalesreport.php">
                <span class="material-symbols-outlined" data-icon="monitoring">monitoring</span>
                <span class="text-sm">Sales Reports</span>
            </a>
            <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-lg active:scale-95" href="superauditlogs.php">
                <span class="material-symbols-outlined" data-icon="assignment">assignment</span>
                <span class="text-sm">Audit Logs</span>
            </a>
            <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-lg active:scale-95" href="supersettings.php">
                <span class="material-symbols-outlined" data-icon="settings">settings</span>
                <span class="text-sm">Settings</span>
            </a>
            <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-lg active:scale-95" href="backup_restore.php">
                <span class="material-symbols-outlined" data-icon="backup" style="font-variation-settings: 'FILL' 1;">backup</span>
        ...
        <div class="p-4 border-t border-slate-100 dark:border-slate-800 space-y-2">
            ...
            <a href="../logout/logout.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors cursor-pointer">
    ...
    <main class="ml-64 min-h-screen">
        <header class="flex items-center justify-between px-8 sticky top-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md w-full h-16 border-b border-slate-200 dark:border-slate-800">
            <div class="flex items-center gap-4">
                <div class="relative">
                    ...
                    <input id="tenantSearchInput" class="pl-10 pr-4 py-1.5 bg-surface-variant border-none text-sm rounded-lg focus:ring-2 focus:ring-primary w-72 transition-all" placeholder="Search tenant rows in table..." type="text" />
                </div>
            </div>
        ...
        <div class="p-8 max-w-7xl mx-auto space-y-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h2 class="text-3xl font-black text-on-background tracking-tight">System Reports &amp; Analytics</h2>
                    <p class="text-on-surface-variant mt-1">Live tenant KPIs, growth, and status insights.</p>
                </div>
                <div class="flex gap-2">
                    <a href="superauditlogs.php" class="bg-white border border-outline px-4 py-2 rounded-lg text-sm font-semibold text-secondary hover:bg-surface-variant transition-colors flex items-center gap-2">
                        <span class="material-symbols-outlined text-sm" data-icon="assignment">assignment</span>
                        View Audit Logs
                    </a>
                    <a href="supersalesreport.php" class="bg-primary text-on-primary px-4 py-2 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity flex items-center gap-2">
            ...
            <section class="bg-surface p-6 rounded-xl border border-outline shadow-sm">
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
                    <div class="space-y-1.5">
                        <label for="date_range" class="text-xs font-bold text-secondary uppercase tracking-wider">Date Range</label>
                        <select id="date_range" name="date_range" class="w-full bg-surface-variant border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/20">
                    ...
                    <div class="space-y-1.5">
                        <label for="tenant" class="text-xs font-bold text-secondary uppercase tracking-wider">Tenant</label>
                        <select id="tenant" name="tenant" class="w-full bg-surface-variant border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/20">
                            <option value="all">All Tenants</option>
                            <?php foreach ($tenantOptions as $option): ?>
                                <option value="<?php echo htmlspecialchars((string) ($option["tenantID"] ?? ""), ENT_QUOTES, "UTF-8"); ?>" <?php echo (string) ($option["tenantID"] ?? "") === (string) $tenantFilter ? "selected" : ""; ?>>
                    ...
                    <div class="space-y-1.5">
                        <label for="status" class="text-xs font-bold text-secondary uppercase tracking-wider">Status</label>
                        <select id="status" name="status" class="w-full bg-surface-variant border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/20">
                            ...
                            <option value="churned" <?php echo $statusFilter === "churned" ? "selected" : ""; ?>>Churned / Inactive</option>
                        </select>
                    </div>
                    <div class="space-y-1.5">
                        <label for="report_type" class="text-xs font-bold text-secondary uppercase tracking-wider">Report Type</label>
                        <div class="flex gap-2">
                            <select id="report_type" name="report_type" class="w-full bg-surface-variant border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/20">
                                <option value="usage" <?php echo $reportType === "usage" ? "selected" : ""; ?>>Usage &amp; Performance</option>
                                <option value="financial" <?php echo $reportType === "financial" ? "selected" : ""; ?>>Financial Summary</option>
                                <option value="security" <?php echo $reportType === "security" ? "selected" : ""; ?>>Security Audit</option>
                                <option value="engagement" <?php echo $reportType === "engagement" ? "selected" : ""; ?>>User Engagement</option>
                            </select>
                            <button type="submit" class="bg-primary text-white px-4 rounded-lg text-sm font-semibold hover:opacity-90">Apply</button>
                        </div>
                    </div>
                </form>
            </section>
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-surface p-6 rounded-xl border border-outline shadow-sm flex flex-col justify-between">
                    <div class="flex justify-between items-start">
                        ...
                        <span class="text-xs font-bold <?php echo $activeTrend >= 0 ? "text-green-600 bg-green-50" : "text-red-600 bg-red-50"; ?> px-2 py-1 rounded-full">
                    ...
                    <div class="mt-4">
                        ...
                        <h3 class="text-2xl font-black text-on-background mt-1"><?php echo formatCount($baseActiveTenants); ?></h3>
                    </div>
                </div>
                ...
                <div class="bg-surface p-6 rounded-xl border border-outline shadow-sm flex flex-col justify-between">
                    <div class="flex justify-between items-start">
                        ...
                        <span class="text-xs font-bold <?php echo $registrationTrend >= 0 ? "text-green-600 bg-green-50" : "text-red-600 bg-red-50"; ?> px-2 py-1 rounded-full">
                            <?php echo ($registrationTrend >= 0 ? "+" : "") . number_format($registrationTrend, 1); ?>%
                        </span>
                    </div>
                    <div class="mt-4">
                        <p class="text-sm font-medium text-on-surface-variant">New Registrations <span class="text-[10px] opacity-70">(Monthly)</span></p>
                        <h3 class="text-2xl font-black text-on-background mt-1"><?php echo formatCount($newRegistrationsCurrent); ?></h3>
                    </div>
                </div>
                ...
                <div class="bg-surface p-6 rounded-xl border border-outline shadow-sm flex flex-col justify-between">
                    <div class="flex justify-between items-start">
                        ...
                        <span class="text-xs font-bold <?php echo $mrrTrend >= 0 ? "text-green-600 bg-green-50" : "text-red-600 bg-red-50"; ?> px-2 py-1 rounded-full">
                    ...
                    <div class="mt-4">
                        ...
                        <h3 class="text-2xl font-black text-on-background mt-1">$<?php echo number_format($baseMrr, 2); ?></h3>
                    </div>
                </div>
                ...
                <div class="bg-surface p-6 rounded-xl border border-outline shadow-sm flex flex-col justify-between">
                    ...
                    <div class="mt-4">
                        ...
                        <h3 class="text-2xl font-black text-on-background mt-1"><?php echo formatPercent($baseRetentionRate); ?></h3>
                    </div>
                </div>
            </section>
            ...
            <section class="bg-surface rounded-xl border border-outline shadow-sm overflow-hidden">
                <div class="p-6 border-b border-outline flex items-center justify-between bg-white">
                    ...
                    <a href="superauditlogs.php" class="text-primary text-sm font-bold flex items-center gap-1 hover:underline">
                        View Full Audit Log
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-surface-variant/50 text-on-surface-variant text-[10px] font-black uppercase tracking-widest">
                        ...
                        <tbody id="tenantTableBody" class="divide-y divide-outline">
                            <?php if (count($tenantRows) === 0): ?>
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-sm text-slate-500">No tenant records found for the selected filters.</td>
                                </tr>
                            <?php endif; ?>
                            ...
                            <?php foreach ($tenantRows as $tenant): ?>
                                ...
                                ?>
                                <tr class="tenant-searchable-row hover:bg-surface-variant/30 transition-colors" data-search="<?php echo htmlspecialchars($searchBlob, ENT_QUOTES, "UTF-8"); ?>">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 rounded bg-slate-100 flex items-center justify-center">
                                                <span class="material-symbols-outlined text-slate-400 text-sm" data-icon="corporate_fare">corporate_fare</span>
                                            </div>
                                            <div>
                                                <div class="text-sm font-bold text-on-background"><?php echo htmlspecialchars((string) $tenant["shop_name"], ENT_QUOTES, "UTF-8"); ?></div>
                                                <?php if ((int) $tenant["tenant_id"] > 0): ?>
                                                    <div class="text-xs text-slate-400">Tenant ID: <?php echo (int) $tenant["tenant_id"]; ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex flex-col gap-1 items-center">
                                            <span class="text-xs font-medium"><?php echo number_format((float) $tenant["storage_gb"], 1); ?> GB</span>
                                            <div class="w-20 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                                <div class="bg-primary h-full" style="width: <?php echo number_format($storagePercent, 1); ?>%;"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-center font-medium text-sm"><?php echo number_format((int) $tenant["active_users"]); ?></td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase <?php echo getStatusBadgeClass($tenant["status"]); ?>">
                                            <?php echo htmlspecialchars((string) $tenant["status"], ENT_QUOTES, "UTF-8"); ?>
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-xs text-on-surface-variant"><?php echo htmlspecialchars((string) $tenant["last_activity"], ENT_QUOTES, "UTF-8"); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                </div>
                <div class="px-6 py-4 bg-slate-50 border-t border-outline flex items-center justify-between text-xs font-medium text-on-surface-variant">
                ...
                new Chart(barCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: "Tenants",
                            data: barData.values,
                            backgroundColor: ["#1152d4", "#f59e0b", "#64748b", "#94a3b8"],
                            borderRadius: 8,
                            borderSkipped: false
                        }]
                    },
